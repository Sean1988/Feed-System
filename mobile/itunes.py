...
class Software(Track):
    ...
    def _set(self, json):
        ...
        self._set_sellerName(json)
        self._set_artistId(json)
        self._set_artistName(json)
        self._set_releaseNotes(json)
        self._set_bundleId(json)
        self._set_languages(json)
        self._set_avg_rating(json)
        self._set_num_ratings(json)
        self._set_primaryGenreName(json)
        self._set_primaryGenreId(json)
        self._set_icon(json)
        self._set_link(json)
    
    def _set_trackName(self, json):
        self.trackName = json.get('trackName', None)
    ...
    def _set_bundleId(self, json):
        self.bundleId = json.get('bundleId', None)

    def _set_sellerName(self, json):
        self.sellerName = json.get('sellerName', None)
    
    def _set_artistId(self, json):
        self.artistId = json.get('artistId', None)
    
    def _set_artistName(self, json):
        self.artistName = json.get('artistName', None)

    def _set_icon(self, json):
        self.icon = json.get('artworkUrl60', None)

    def _set_link(self, json):
        self.link = json.get('artistViewUrl', None)

    def _set_releaseNotes(self, json):
        self.releaseNotes = json.get('releaseNotes', None)

    def _set_primaryGenreName(self, json):  
        self.primaryGenreName = json.get('primaryGenreName', None) 

    def _set_primaryGenreId(self, json):  
        self.primaryGenreId = json.get('primaryGenreId', None) 
    ...
    def get_primaryGenreId(self):
        return self.primaryGenreId
    def get_primaryGenreName(self):
