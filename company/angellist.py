...
app1 = {
        'client_id'  : '48067c4baef7daf922c4bfe3cea3a6cf',
        'client_secret' : '44b7011d898ac9d9f508454e93c0b900',
        'access_token' : '561912254ae0cce8f1d3d7a17dfc23d6'
       }

app2 = { 'client_id': 'fbe5328a2b517c44d6e34969416314df', 
         'client_secret' :  'b5992521e0b88e7e96c8940b4cb05083',
         'access_token' : '87cc4bff024cc24067627d9d9bd25f50'
       }

app3 = { 'client_id' : '27c7526456456fe2364ab9ba507af88b', 
         'client_secret' :  'e329cf080d344e2ada53f7ff7f292498',
         'access_token' : '4a0aa89223d5146b0d096829be9a7d13'
       }
...
class AngelList(object):
    def __init__(self):
        ...
        self.client_id         = app1['client_id']
        self.client_secret     = app1['client_secret']
        self.access_token      = app1['access_token']
        self.account = 0
    ...
    def switchAccount(self):
        ...
        self.account +=1
        if self.account == len(app_list):
            self.account = 0
        self.client_id = app_list[self.account]['client_id']
        self.client_secret = app_list[self.account]['client_secret']
        self.access_token  = app_list[self.account]['access_token']
